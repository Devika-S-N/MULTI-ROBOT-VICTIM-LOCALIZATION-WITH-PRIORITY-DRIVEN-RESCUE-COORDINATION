...
def make_phase1_video_from_logs(
    ...
    title_text = ax.set_title("Phase 1: Global Distributed Consensus", fontsize=10)
    ...
    def step(frame_idx):
        ...
        title_text.set_text(f"Phase 1: Global Distributed Consensus — t = {t:.1f} s")
...
def make_phase2_video_from_logs(
    ...
    title_text = ax.set_title("Phase 2: Local Rendezvous Consensus", fontsize=10)
    ...
    def step(frame_idx):
        ...
        for i, (artist, label) in enumerate(zip(robot_artists, robot_labels)):
            ...
            artist.set_offsets([pos[0], pos[1]])
            label.set_position((pos[0] + 0.1, pos[1] + 0.1))
        title_text.set_text(f"Phase 2: Local Rendezvous Consensus — t = {t:.1f} s")
        return robot_artists + robot_labels + [title_text]
